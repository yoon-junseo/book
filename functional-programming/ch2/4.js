...
// 2-62
if (function f1() {}) console.log("hi"); // hi
...
if (add(1, 2)) console.log("hi1"); // hi1
...
var v1 = a || b; // a가 긍정적인 값이면 || 이후를 확인하지 않아 a 값이 v1에 담긴다.
console.log(v1); // hi

var v2 = b || a; // b가 부정적인 값이어서 a를 확인했고 a의 값이 담긴다.
console.log(v2); // hi

var v3 = a && b; // a가 긍정적인 값이어서 && 이후를 확인하게 되고 b 값이 담긴다.
console.log(v3); // ""

var v4 = b && a; // b가 falsy 값이어서 && 이후를 확인할 필요 없이 b 값이 담긴다.
console.log(v4); // ""
